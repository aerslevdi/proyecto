                ...
                <div class="card-body">
                    ...
                    enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" placeholder="ej:Pablo Gomez,ej:Telefonica" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="mail" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" placeholder="ejemplo@exp.com"required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="iden" type="text" class="form-control{{ $errors->has('iden') ? ' is-invalid' : '' }}" name="iden" value="{{ old('iden') }}" placeholder="2312743421" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tel" type="tel" class="form-control{{ $errors->has('telefono') ? ' is-invalid' : '' }}" name="telefono" value="{{ old('telefono') }}" placeholder="(011)15-743421" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="direccion" type="text" class="form-control{{ $errors->has('direccion') ? ' is-invalid' : '' }}" name="direccion" placeholder="Buenos Aires" value="{{ old('direccion') }}" required>
